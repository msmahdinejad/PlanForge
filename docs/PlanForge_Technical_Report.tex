...
\begin{center}
\texttt{JSON problem -> finite domains -> student solver -> validator -> visualizer}
\end{center}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{guide-visual-solve-tree.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{guide-solved-layout.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{guide-public-grader.png}
